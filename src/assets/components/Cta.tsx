const Cta = () => {
  return (
    <>
      <section id="cta" className='bg-green-700 py-16'>
        <div className='max-w-7xl mx-3 md:mx-auto flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-0 justify-between'>
          ...
          <div className='w-fit'>
            <a href="" className='text-nowrap flex items-center gap-2 text-white bg-orange-400 px-7 py-3 rounded-full hover:bg-orange-500 text-sm'>Hubungi Kami

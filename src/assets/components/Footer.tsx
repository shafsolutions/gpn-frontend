      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 py-8 md:gap-0">
          <div className='flex flex-row md:flex-col items-center md:items-start gap-3 md:gap-0'>
            <img src="./assets/media/img/logo-gpn.png" alt="" className='w-[80px] md:w-[140px] mb-3' />
          ...
          <ul className="flex flex-col md:flex-row items-center gap-4 text-gray-700 font-medium">
            <li><a href="#" className="hover:text-blue-600 text-sm">Tentang Kami</a></li>
            <li><a href="#" className="hover:text-blue-600 text-sm">Kecamatan</a></li>
            <li><a href="#" className="hover:text-blue-600 text-sm">Galeri</a></li>
            <li><a href="#" className="hover:text-blue-600 text-sm">Artikel</a></li>
            <li><a href="#" className="hover:text-blue-600 text-sm">Hubungi Kami</a></li>
          </ul>
          ...
          <div className="flex flex-col gap-2 items-center md:items-end">
            ...
            <a href="" className='flex items-center gap-2 bg-yellow-400 px-7 py-3 rounded-full hover:bg-yellow-500 text-sm'>
              Gabung GPN 

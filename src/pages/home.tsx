...
const Home = () => {
  return (
    <>
      <Navbar />
      <section className='bg-lightblue py-24 md:py-42'>
        <div className="max-w-7xl h-fit mx-3 md:mx-auto md:h-[520px] flex items-center">
          <div className='grid grid-cols-1 md:grid-cols-5 items-center'>
            <div className='col-span-3'>
              <div className='flex flex-col gap-4'>
                <h1 className='text-[48px] md:text-[64px] font-bold text-blue-700 leading-12 md:leading-16'>Suara Muda dari Ujung Utara Indonesia</h1>
                <p>Kami bukan sekadar organisasi, kami adalah gerakan. <br />Bergabunglah, dan jadi bagian dari perubahan</p>
                <div className='flex flex-col md:flex-row items-start  gap-2'>
                  <a href="" className='w-fit text-nowrap flex items-center gap-2 bg-blue-600 px-7 py-3 rounded-full hover:bg-blue-700 text-sm text-white'>Gabung sekarang
                  ...
                  <a href="" className='w-fit text-nowrap flex items-center gap-2 bg-yellow-400 px-7 py-3 rounded-full hover:bg-yellow-500 text-sm'>Lihat lebih banyak
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="dark" viewBox="0 0 256 256"><path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path></svg>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className='max-w-7xl mx-3 md:mx-auto flex flex-col gap-6 md:gap-8'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <a href="" className='w-fit text-nowrap flex items-center gap-2 bg-blue-600 px-7 py-3 rounded-full hover:bg-blue-700 text-sm text-white'>Kenali lebih dekat
          ...
          <div className="flex w-full overflow-x-auto space-x-4 px-4 py-4">
            {[...Array(4)].map((_, i) => (
              <a href="" key={i} className='w-fit'>
                <div className='bg-blue-100 hover:bg-blue-200 scale-100 hover:scale-102 duration-200 ease-out rounded-lg w-[300px] overflow-auto'>
                  ...
                  <div className='flex flex-col gap-3 px-4 py-5'>
                    ...
                    <h4 className='text-[18px] text-blue-primary font-semibold'>Pemuda Natuna Gelar Pelatihan Kewirausahaan Digital</h4>
